...
var feng3d = (function (exports, renderer, event, objectview, serialization, watcher, polyfill, math, filesystem, task, shortcut) {
	'use strict';

	renderer.shaderlib.shaderConfig = {
	    "shaders": {
	        "color": {
	...
	event.globalEmitter.on("asset.shaderChanged", function () {
	    renderer.shaderlib.clearCache();
	});
	...
	***************************************************************************** */
	...
	var Feng3dObject = /*@__PURE__*/(function (EventEmitter) {
	    function Feng3dObject() {
	         ...
	         */
	        this.hideFlags = exports.HideFlags.None;
	        this._disposed = false;
	        Object.defineProperty(this, "uuid", { value: polyfill.mathUtil.uuid() });
	...
	serialization.serialization.serializeHandlers.push(
	// 处理 Feng3dObject
	{
	    priority: 0,
	    handler: function (target, source, property) {
	        var spv = source[property];
	        if (spv instanceof Feng3dObject && (spv.hideFlags & exports.HideFlags.DontSave)) {
	            return true;
	        }
	        return false;
	    }
	...
	var BoundingBox = function BoundingBox(node3d) {
	    this._selfLocalBounds = new math.Box3();
	    this._selfWorldBounds = new math.Box3();
	    this._worldBounds = new math.Box3();
	 ...
	 */
	exports.Node3D = /*@__PURE__*/(function (Component) {
	    function Node3D() {
	        var this$1 = this;

	        Component.call(this);
	        this.assetType = exports.AssetType.node3d;
	        /**
	         * 自身以及子对象是否支持鼠标拾取
	         */
	        ...
	        this._orientation = new math.Quaternion();
	        this._matrix = new math.Matrix4x4();
	        this._matrixInvalid = false;
	        this._rotationMatrix = new math.Matrix4x4();
	        this._rotationMatrixInvalid = false;
	        this._localToWorldMatrix = new math.Matrix4x4();
	        this._localToWorldMatrixInvalid = false;
	        this._ITlocalToWorldMatrix = new math.Matrix4x4();
	        this._ITlocalToWorldMatrixInvalid = false;
	        this._worldToLocalMatrix = new math.Matrix4x4();
	        this._worldToLocalMatrixInvalid = false;
	        this._localToWorldRotationMatrix = new math.Matrix4x4();
	        this._localToWorldRotationMatrixInvalid = false;
	        this._children = [];
	        this._renderAtomic = new renderer.RenderAtomic();
	    ...
	    Node3D.prototype.getPosition = function getPosition (p) {
	        if ( p === void 0 ) p = new math.Vector3();
	    ...
	    prototypeAccessors.orientation.set = function (value) {
	        ...
	        angles.scaleNumber(polyfill.mathUtil.RAD2DEG);
	        this.rx = angles.x;
	        this.ry = angles.y;
	        this.rz = angles.z;
	    };
	    ...
	    Node3D.prototype.pitch = function pitch (angle) {
	        this.rotate(math.Vector3.X_AXIS, angle);
	    };
	    Node3D.prototype.yaw = function yaw (angle) {
	        this.rotate(math.Vector3.Y_AXIS, angle);
	    };
	    Node3D.prototype.roll = function roll (angle) {
	        this.rotate(math.Vector3.Z_AXIS, angle);
	    };
	    ...
	    Node3D.prototype.rotate = function rotate (axis, angle, pivotPoint) {
	        //转换位移
	        var positionMatrix = math.Matrix4x4.fromPosition(this._x, this._y, this._z);
	        positionMatrix.appendRotation(axis, angle, pivotPoint);
	        var position = positionMatrix.getPosition();
	        //转换旋转
	        var rotationMatrix = math.Matrix4x4.fromRotation(this.rx, this.ry, this.rz);
	    ...
	    Node3D.prototype.localToWolrdBox = function localToWolrdBox (box, out) {
	        if ( out === void 0 ) out = new math.Box3();
	    ...
	    Node3D.prototype.worldToLocalPoint = function worldToLocalPoint (position, out) {
	        if ( out === void 0 ) out = new math.Vector3();
	    ...
	    Node3D.prototype.rayWorldToLocal = function rayWorldToLocal (worldRay, localRay) {
	        if ( localRay === void 0 ) localRay = new math.Ray3();
	...
	__decorate([
	    serialization.serialize
	], exports.Node3D.prototype, "prefabId", void 0);
	__decorate([
	    serialization.serialize
	], exports.Node3D.prototype, "assetId", void 0);
	__decorate([
	    serialization.serialize
	], exports.Node3D.prototype, "mouseEnabled", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "x", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "y", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "z", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "rx", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "ry", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "rz", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "sx", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "sy", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Node3D.prototype, "sz", null);
	__decorate([
	    serialization.serialize
	], exports.Node3D.prototype, "visible", null);
	__decorate([
	    serialization.serialize
	], exports.Node3D.prototype, "children", null);
	exports.Node3D = __decorate([
	    RegisterComponent({ single: true })
	], exports.Node3D);
	var tempVector3_1 = new math.Vector3();
	var tempVector3_2 = new math.Vector3();
	var tempVector3_3 = new math.Vector3();
	...
	var Component3D = /*@__PURE__*/(function (Component) {
	    ...
	    prototypeAccessors.node3d.get = function () {
	        var _a;
	        return (_a = this._entity) === null || _a === void 0 ? void 0 : _a.getComponent(exports.Node3D);
	    };
	    /**
	 ...
	 * 可以控制开关的组件
	 */
	exports.Behaviour = /*@__PURE__*/(function (Component3D) {
	    function Behaviour() {
	         ...
	         * 可运行环境
	         */
	        this.runEnvironment = exports.RunEnvironment.all;
	    }
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.Behaviour.prototype, "enabled", void 0);
	exports.Behaviour = __decorate([
	    RegisterComponent()
	], exports.Behaviour);
	...
	var AnimationClip = /*@__PURE__*/(function (Feng3dObject) {
	    function AnimationClip() {
	        ...
	        this.assetType = exports.AssetType.anim;
	        this.loop = true;
	    }
	...
	PropertyClip.prototype.interpolation = function interpolation (prevalue, nextValue, factor) {
	    var propertyValue;
	    if (prevalue instanceof math.Quaternion) {
	        propertyValue = prevalue.clone();
	        propertyValue.lerp(prevalue, nextValue, factor);
	    }
	    else if (prevalue instanceof math.Vector3) {
	        propertyValue = new math.Vector3(prevalue.x * (1 - factor) + nextValue.x * factor, prevalue.y * (1 - factor) + nextValue.y * factor, prevalue.z * (1 - factor) + nextValue.z * factor);
	    }
	    else {
	...
	PropertyClip.prototype.getpropertyValue = function getpropertyValue (value) {
	    ...
	    if (this.type == "Vector3")
	        { return math.Vector3.fromArray(value); }
	    if (this.type == "Quaternion")
	        { return math.Quaternion.fromArray(value); }
	...
	__decorate([
	    objectview.oav({ component: "OAVDefault", componentParam: { dragparam: { accepttype: "animationclip", datatype: "animationclip" } } }),
	    serialization.serialize,
	    watcher.watch("_onAnimationChanged")
	], exports.Animation.prototype, "animation", void 0);
	__decorate([
	    objectview.oav({ component: "OAVArray", componentParam: { dragparam: { accepttype: "animationclip", datatype: "animationclip" }, defaultItem: function () { return new AnimationClip(); } } }),
	    serialization.serialize
	], exports.Animation.prototype, "animations", void 0);
	__decorate([
	    objectview.oav(),
	    watcher.watch("_onTimeChanged")
	], exports.Animation.prototype, "time", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.Animation.prototype, "isplaying", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.Animation.prototype, "playspeed", void 0);
	exports.Animation = __decorate([
	 ...
	 * 3d对象脚本
	 */
	exports.ScriptComponent = /*@__PURE__*/(function (Behaviour) {
	    function ScriptComponent() {
	        Behaviour.apply(this, arguments);
	        this.runEnvironment = exports.RunEnvironment.feng3d;
	        this._invalid = true;
	    ...
	    ScriptComponent.prototype.init = function init () {
	        ...
	        event.globalEmitter.on("asset.scriptChanged", this._invalidateScriptInstance, this);
	    };
	    ScriptComponent.prototype._updateScriptInstance = function _updateScriptInstance () {
	        ...
	        if (!this.scriptName)
	            { return; }
	        var cls = polyfill.classUtils.getDefinitionByName(this.scriptName, false);
	        if (cls)
	        ...
	        if (oldInstance) {
	            ...
	            if (polyfill.classUtils.getQualifiedClassName(oldInstance) == this.scriptName) {
	                serialization.serialization.setValue(this._scriptInstance, oldInstance);
	            }
	    ...
	    ScriptComponent.prototype.dispose = function dispose () {
	        ...
	        Behaviour.prototype.dispose.call(this);
	        event.globalEmitter.off("asset.scriptChanged", this._invalidateScriptInstance, this);
	    };
	...
	__decorate([
	    serialization.serialize,
	    watcher.watch("_invalidateScriptInstance"),
	    objectview.oav({ component: "OAVPick", componentParam: { accepttype: "file_script" } })
	], exports.ScriptComponent.prototype, "scriptName", void 0);
	__decorate([
	    serialization.serialize
	], exports.ScriptComponent.prototype, "scriptInstance", null);
	exports.ScriptComponent = __decorate([
	...
	var Entity = /*@__PURE__*/(function (Feng3dObject) {
	    ...
	    Entity.prototype.addScript = function addScript (scriptName) {
	        var scriptComponent = new exports.ScriptComponent();
	    ...
	    prototypeAccessors.children.set = function (v) {
	        ...
	        var node3ds = v.map(function (v) { return v.getComponent(exports.Node3D); });
	        var node3d = this.getComponent(exports.Node3D);
	        if (node3d) {
	            node3d.children = node3ds;
	        }
	        else {
	            var f = function (e) {
	                if (e.data.entity == this$1 && e.data.component instanceof exports.Node3D) {
	    ...
	    Entity.createPrimitive = function createPrimitive (type, param) {
	        ...
	        if (createHandler != null)
	            { createHandler(g); }
	        serialization.serialization.setValue(g, param);
	        return g.getComponent(exports.Node3D);
	    };
	    /**
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEntityName" })
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVComponentList" })
	...
	exports.SkeletonComponent = /*@__PURE__*/(function (Component3D) {
	    ...
	    SkeletonComponent.prototype.initSkeleton = function initSkeleton () {
	        ...
	        for (var i = 0; i < jointNum; i++) {
	            ...
	            this.globalMatrixs[i] = new math.Matrix4x4();
	            this._globalMatrices[i] = new math.Matrix4x4();
	        }
	    };
	    /**
	     * 更新骨骼全局变换矩阵
	    ...
	    SkeletonComponent.prototype.createSkeletonNode3D = function createSkeletonNode3D () {
	        ...
	        function createJoint(i) {
	            ...
	            if (!jointTransform) {
	                ...
	                entity.hideFlags = exports.HideFlags.DontSave;
	                jointTransform = entity.addComponent(exports.Node3D);
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.SkeletonComponent.prototype, "joints", void 0);
	exports.SkeletonComponent = __decorate([
	    RegisterComponent()
	...
	var AssetData = /*@__PURE__*/(function (Feng3dObject) {
	    ...
	    AssetData.isAssetData = function isAssetData (asset) {
	        ...
	        if (asset instanceof AssetData)
	            { return true; }
	        if (polyfill.classUtils.getDefaultInstanceByName(asset[polyfill.__class__]) instanceof AssetData)
	            { return true; }
	    };
	    /**
	     * 序列化
	    ...
	    AssetData.serialize = function serialize (asset) {
	        var obj = {};
	        obj[polyfill.__class__] = polyfill.classUtils.getQualifiedClassName(asset);
	 ...
	 * 设置函数列表
	 */
	serialization.serialization.setValueHandlers.push(
	// 处理资源
	{
	    priority: 0,
	    handler: function (target, source, property, param) {
	        ...
	        if (AssetData.isAssetData(tpv)) {
	            if (spv.__class__ == null) {
	                var className = polyfill.classUtils.getQualifiedClassName(tpv);
	                var inst = polyfill.classUtils.getInstanceByName(className);
	...
	serialization.serialization.deserializeHandlers.push(
	// 处理资源
	{
	    priority: 0,
	    handler: function (target, source, property, param) {
	...
	serialization.serialization.differentHandlers.push(
	// 资源
	{
	    priority: 0,
	    handler: function (target, source, property, param) {
	...
	GeometryUtils.prototype.applyTransformation = function applyTransformation (matrix, positions, normals, tangents) {
	    ...
	    var invTranspose = new math.Matrix4x4();
	...
	GeometryUtils.prototype.raycast = function raycast (ray, indices, positions, uvs, shortestCollisionDistance, cullFace) {
	        ...
	        if ( cullFace === void 0 ) cullFace = renderer.CullFace.NONE;

	    if (cullFace == renderer.CullFace.FRONT_AND_BACK)
	        { return null; }
	    var t = 0;
	    var i0 = 0, i1 = 0, i2 = 0;
	    var rx = 0, ry = 0, rz = 0;
	    ...
	    for (var index = 0; index < numIndices; index += 3) { // sweep all triangles
	        ...
	        //判断射线是否与三角面相交
	        if ((cullFace == renderer.CullFace.FRONT && nDotV > 0.0) || (cullFace == renderer.CullFace.BACK && nDotV < 0.0) || (cullFace == renderer.CullFace.NONE && nDotV != 0.0)) { // an intersection must exist
	            //计算平面方程D值，参考Plane3D
	            ...
	            if (u >= 0 && t >= 0 && t < shortestCollisionDistance) {
	                ...
	                result.localPosition = new math.Vector3(cx, cy, cz);
	                result.localNormal = new math.Vector3(nx, ny, nz);
	                if (uvs) {
	...
	GeometryUtils.prototype.getAABB = function getAABB (positions) {
	    return math.Box3.formPositions(positions);
	};
	...
	var Geometry = /*@__PURE__*/(function (Feng3dObject) {
	    function Geometry() {
	        Feng3dObject.call(this);
	        this.preview = "";
	        this.assetType = exports.AssetType.geometry;
	        /**
	         * 纹理U缩放，默认为1。
	         */
	        this.scaleU = 1;
	         ...
	         * 顶点索引缓冲
	         */
	        this._indexBuffer = new renderer.Index();
	        /**
	         * 属性数据列表
	         */
	        this._attributes = {
	            a_position: new renderer.Attribute("a_position", [], 3),
	            a_color: new renderer.Attribute("a_color", [], 4),
	            a_uv: new renderer.Attribute("a_uv", [], 2),
	            a_normal: new renderer.Attribute("a_normal", [], 3),
	            a_tangent: new renderer.Attribute("a_tangent", [], 3),
	            a_skinIndices: new renderer.Attribute("a_skinIndices", [], 4),
	            a_skinWeights: new renderer.Attribute("a_skinWeights", [], 4),
	            a_skinIndices1: new renderer.Attribute("a_skinIndices1", [], 4),
	            a_skinWeights1: new renderer.Attribute("a_skinWeights1", [], 4),
	        };
	    ...
	    prototypeAccessors.bounding.get = function () {
	        ...
	        if (!this._bounding) {
	            ...
	            this._bounding = math.Box3.formPositions(this.positions);
	        }
	    ...
	    Geometry.prototype.getVertices = function getVertices (result) {
	        ...
	        for (var i = 0, n = positions.length; i < n; i += 3) {
	            result.push(new math.Vector3(positions[i], positions[i + 1], positions[i + 2]));
	        }
	        return result;
	    };
	    ...
	    Geometry.setDefault = function setDefault (name, geometry, param) {
	        ...
	        if (param)
	            { serialization.serialization.setValue(geometry, param); }
	        serialization.serialization.setValue(geometry, { name: name, assetId: name, hideFlags: exports.HideFlags.NotEditable });
	...
	__decorate([
	    objectview.oav({ component: "OAVFeng3dPreView" })
	], Geometry.prototype, "preview", void 0);
	__decorate([
	    objectview.oav()
	], Geometry.prototype, "name", null);
	__decorate([
	    objectview.oav({ component: "OAVMultiText", priority: 10 })
	], Geometry.prototype, "geometryInfo", null);
	__decorate([
	    objectview.oav({ tooltip: "标记需要更新几何体，在更改几何体数据后需要调用该函数。" })
	...
	LightPicker.prototype.beforeRender = function beforeRender (renderAtomic) {
	    ...
	    pointLights.forEach(function (element) {
	        if (!element.isVisibleAndEnabled)
	            { return; }
	        if (element.shadowType != exports.ShadowType.No_Shadows && this$1._model.receiveShadows) {
	...
	var ImageUtil = function ImageUtil(width, height, fillcolor) {
	    ...
	    if ( fillcolor === void 0 ) fillcolor = new math.Color4(0, 0, 0, 0);
	...
	ImageUtil.prototype.init = function init (width, height, fillcolor) {
	    ...
	    this.fillRect(new math.Rectangle(0, 0, width, height), fillcolor);
	};
	/**
	 * 获取图片数据
	 * @param image 加载完成的图片元素
	...
	ImageUtil.prototype.getPixel = function getPixel (x, y) {
	    ...
	    var color = new math.Color4(this.imageData.data[pos] / 255, this.imageData.data[pos + 1] / 255, this.imageData.data[pos + 2] / 255, this.imageData.data[pos + 3] / 255);
	    return color;
	};
	/**
	 * 设置指定位置颜色值
	...
	ImageUtil.prototype.clear = function clear (clearColor) {
	        if ( clearColor === void 0 ) clearColor = new math.Color4(0, 0, 0, 0);
	...
	ImageUtil.prototype.fillRect = function fillRect (rect, fillcolor) {
	        if ( fillcolor === void 0 ) fillcolor = new math.Color4();
	...
	ImageUtil.prototype.drawImageData = function drawImageData (imageData, x, y) {
	    var rect = new math.Rectangle(0, 0, this.imageData.width, this.imageData.height).intersection(new math.Rectangle(x, y, imageData.width, imageData.height));
	...
	ImageUtil.prototype.toDataURL = function toDataURL () {
	    return polyfill.dataTransform.imageDataToDataURL(this.imageData);
	};
	/**
	 * 创建默认粒子贴图
	 * @param size 尺寸
	...
	ImageUtil.prototype.drawDefaultParticle = function drawDefaultParticle (size) {
	    ...
	    for (var i = 0; i < size; i++) {
	        for (var j = 0; j < size; j++) {
	            var l = polyfill.mathUtil.clamp(new math.Vector2(i - half, j - half).length, 0, half) / half;
	            var f = 1 - l;
	            f = f * f;
	            var pos = (i + j * size) * 4;
	...
	ImageUtil.prototype.drawColorPickerRect = function drawColorPickerRect (color) {
	    Image;
	    var leftTop = new math.Color3(1, 1, 1);
	    var rightTop = new math.Color3().fromUnit(color);
	    var leftBottom = new math.Color3(0, 0, 0);
	    var rightBottom = new math.Color3(0, 0, 0);
	    //
	    for (var i = 0; i < this.imageData.width; i++) {
	        for (var j = 0; j < this.imageData.height; j++) {
	...
	ImageUtil.prototype.drawColorRect = function drawColorRect (color) {
	    ...
	    color4.a = 1;
	    var white = new math.Color4(1, 1, 1);
	    var black = new math.Color4(0, 0, 0);
	    //
	    for (var i = 0; i < this.imageData.width; i++) {
	        for (var j = 0; j < this.imageData.height; j++) {
	            //
	...
	ImageUtil.prototype.drawCurve = function drawCurve (curve, between0And1, color, rect) {
	    ...
	    rect = rect || new math.Rectangle(0, 0, this.imageData.width, this.imageData.height);
	    var range = between0And1 ? [1, 0] : [1, -1];
	    var prepos = new math.Vector2();
	    var curpos = new math.Vector2();
	    //
	    for (var i = 0; i < rect.width; i++) {
	        //
	        var y = curve.getValue(i / (rect.width - 1));
	        y = polyfill.mathUtil.mapLinear(y, range[0], range[1], 0, 1);
	...
	ImageUtil.prototype.drawBetweenTwoCurves = function drawBetweenTwoCurves (curve, curve1, between0And1, curveColor, fillcolor, rect) {
	        if ( curveColor === void 0 ) curveColor = new math.Color4();
	        if ( fillcolor === void 0 ) fillcolor = new math.Color4(1, 1, 1, 0.5);
	        if ( rect === void 0 ) rect = null;

	    rect = rect || new math.Rectangle(0, 0, this.imageData.width, this.imageData.height);
	    var range = between0And1 ? [1, 0] : [1, -1];
	    var prepos0 = new math.Vector2();
	    var curpos0 = new math.Vector2();
	    var prepos1 = new math.Vector2();
	    var curpos1 = new math.Vector2();
	    //
	    for (var i = 0; i < rect.width; i++) {
	        //
	        var y0 = curve.getValue(i / (rect.width - 1));
	        var y1 = curve1.getValue(i / (rect.width - 1));
	        y0 = polyfill.mathUtil.mapLinear(y0, range[0], range[1], 0, 1);
	        y1 = polyfill.mathUtil.mapLinear(y1, range[0], range[1], 0, 1);
	        ...
	        curpos1.x = rect.x + i;
	        curpos1.y = rect.y + y1;
	        this.drawLine(new math.Vector2(rect.x + i, rect.y + y0), new math.Vector2(rect.x + i, rect.y + y1), fillcolor);
	        if (i > 0) {
	...
	var imageDatas = {
	    black: new ImageUtil(1, 1, math.Color4.fromUnit24(math.ColorKeywords.black)).imageData,
	    white: new ImageUtil(1, 1, math.Color4.fromUnit24(math.ColorKeywords.white)).imageData,
	    red: new ImageUtil(1, 1, math.Color4.fromUnit24(math.ColorKeywords.red)).imageData,
	    green: new ImageUtil(1, 1, math.Color4.fromUnit24(math.ColorKeywords.green)).imageData,
	    blue: new ImageUtil(1, 1, math.Color4.fromUnit24(math.ColorKeywords.blue)).imageData,
	    defaultNormal: new ImageUtil(1, 1, math.Color4.fromUnit24(0x8080ff)).imageData,
	...
	var TextureInfo = /*@__PURE__*/(function (Feng3dObject) {
	    function TextureInfo() {
	         ...
	         * 格式
	         */
	        this.format = renderer.TextureFormat.RGBA;
	        /**
	         * 数据类型
	         */
	        this.type = renderer.TextureDataType.UNSIGNED_BYTE;
	        /**
	         * 是否生成mipmap
	         */
	        ...
	        this.minFilter = renderer.TextureMinFilter.LINEAR;
	        this.magFilter = renderer.TextureMagFilter.LINEAR;
	        this._wrapS = renderer.TextureWrap.REPEAT;
	        this._wrapT = renderer.TextureWrap.REPEAT;
	        /**
	    ...
	    prototypeAccessors.wrapS.get = function () {
	        if (!this.isPowerOfTwo)
	            { return renderer.TextureWrap.CLAMP_TO_EDGE; }
	        return this._wrapS;
	    };
	    ...
	    prototypeAccessors.isPowerOfTwo.get = function () {
	        if (this.isRenderTarget) {
	            if (this.OFFSCREEN_WIDTH == 0 || !polyfill.mathUtil.isPowerOfTwo(this.OFFSCREEN_WIDTH))
	                { return false; }
	            if (this.OFFSCREEN_HEIGHT == 0 || !polyfill.mathUtil.isPowerOfTwo(this.OFFSCREEN_HEIGHT))
	                { return false; }
	            return true;
	        }
	        ...
	        for (var i = 0; i < pixels.length; i++) {
	            ...
	            if (element.width == 0 || !polyfill.mathUtil.isPowerOfTwo(element.width))
	                { return false; }
	            if (element.height == 0 || !polyfill.mathUtil.isPowerOfTwo(element.height))
	                { return false; }
	        }
	        return true;
	    };
	    ...
	    TextureInfo.prototype.getSize = function getSize () {
	        if (this.isRenderTarget) {
	            return new math.Vector2(this.OFFSCREEN_WIDTH, this.OFFSCREEN_HEIGHT);
	        }
	        var pixels = this.activePixels;
	        if (!pixels)
	        ...
	        if (!Array.isArray(pixels))
	            { pixels = [pixels]; }
	        if (pixels.length == 0)
	            { return new math.Vector2(1, 1); }
	        var pixel = pixels[0];
	        return new math.Vector2(pixel.width, pixel.height);
	    };
	    /**
	     * 判断数据是否满足渲染需求
	     */
	    ...
	    prototypeAccessors.dataURL.get = function () {
	        ...
	        if (!this._dataURL) {
	            if (this._activePixels instanceof ImageData)
	                { this._dataURL = polyfill.dataTransform.imageDataToDataURL(this._activePixels); }
	            else if (this._activePixels instanceof HTMLImageElement)
	                { this._dataURL = polyfill.dataTransform.imageToDataURL(this._activePixels); }
	            else if (this._activePixels instanceof HTMLCanvasElement)
	                { this._dataURL = polyfill.dataTransform.canvasToDataURL(this._activePixels); }
	        }
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: renderer.TextureFormat } }),
	    watcher.watch("invalidate")
	], TextureInfo.prototype, "format", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: renderer.TextureDataType } }),
	    watcher.watch("invalidate")
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: renderer.TextureMinFilter } })
	], TextureInfo.prototype, "minFilter", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: renderer.TextureMagFilter } })
	], TextureInfo.prototype, "magFilter", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: renderer.TextureWrap } })
	...
	var Texture2D = /*@__PURE__*/(function (TextureInfo) {
	    function Texture2D() {
	         ...
	         * 纹理类型
	         */
	        this.textureType = renderer.TextureType.TEXTURE_2D;
	        this.assetType = exports.AssetType.texture;
	        /**
	         * 当贴图数据未加载好等情况时代替使用
	         */
	    ...
	    prototypeAccessors.source.set = function (v) {
	        ...
	        if (v.url) {
	            ...
	            filesystem.loader.loadImage(v.url, function (img) {
	                this$1._pixels = img;
	                this$1.invalidate();
	...
	Texture2D.white = serialization.serialization.setValue(new Texture2D(), { name: "white-Texture", noPixels: ImageDatas.white, hideFlags: exports.HideFlags.NotEditable });
	Texture2D.default = serialization.serialization.setValue(new Texture2D(), { name: "Default-Texture", hideFlags: exports.HideFlags.NotEditable });
	Texture2D.defaultNormal = serialization.serialization.setValue(new Texture2D(), { name: "Default-NormalTexture", noPixels: ImageDatas.defaultNormal, hideFlags: exports.HideFlags.NotEditable });
	Texture2D.defaultParticle = serialization.serialization.setValue(new Texture2D(), { name: "Default-ParticleTexture", noPixels: ImageDatas.defaultParticle, format: renderer.TextureFormat.RGBA, hideFlags: exports.HideFlags.NotEditable });
	...
	var TextureCube = /*@__PURE__*/(function (TextureInfo) {
	    function TextureCube() {
	        ...
	        this.textureType = renderer.TextureType.TEXTURE_CUBE_MAP;
	        this.assetType = exports.AssetType.texturecube;
	        this.OAVCubeMap = "";
	    ...
	    TextureCube.prototype.getTextureImage = function getTextureImage (pos, callback) {
	        ...
	        if (this.rawData.type == "texture") {
	            ...
	            filesystem.fs.readImage(path, function (err, img) {
	                callback(img);
	            });
	        }
	    };
	    ...
	    TextureCube.prototype._loadItemImagePath = function _loadItemImagePath (imagepath, index) {
	        ...
	        filesystem.fs.readImage(imagepath, function (err, img) {
	...
	__decorate([
	    objectview.oav({ component: "OAVCubeMap", priority: -1 })
	], TextureCube.prototype, "OAVCubeMap", void 0);
	__decorate([
	    serialization.serialize,
	    watcher.watch("_rawDataChanged")
	], TextureCube.prototype, "rawData", void 0);
	TextureCube.default = serialization.serialization.setValue(new TextureCube(), { name: "Default-TextureCube", hideFlags: exports.HideFlags.NotEditable });
	...
	var Material = /*@__PURE__*/(function (Feng3dObject) {
	    function Material() {
	        Feng3dObject.call(this);
	        //
	        this.renderAtomic = new renderer.RenderAtomic();
	        this.preview = "";
	        this._name = "";
	        event.globalEmitter.on("asset.shaderChanged", this._onShaderChanged, this);
	    ...
	    Material.prototype.init = function init (shaderName, uniforms, renderParams) {
	        ...
	        //
	        uniforms && serialization.serialization.setValue(this.uniforms, uniforms);
	        renderParams && serialization.serialization.setValue(this.renderParams, renderParams);
	        return this;
	    };
	    prototypeAccessors.name.get = function () {
	        return this._name;
	    ...
	    Material.prototype.beforeRender = function beforeRender (renderAtomic) {
	        ...
	        renderAtomic.shaderMacro.IS_POINTS_MODE = this.renderParams.renderMode == renderer.RenderMode.POINTS;
	    };
	    /**
	     * 是否加载完成
	     */
	    ...
	    Material.prototype._onShaderChanged = function _onShaderChanged () {
	        var cls = renderer.shaderlib.shaderConfig.shaders[this.shaderName].cls;
	        if (cls) {
	        ...
	        var renderParams = renderer.shaderlib.shaderConfig.shaders[this.shaderName].renderParams;
	        renderParams && serialization.serialization.setValue(this.renderParams, renderParams);
	        this.renderAtomic.shader = new renderer.Shader(this.shaderName);
	    };
	    ...
	    Material.setDefault = function setDefault (name, material) {
	        ...
	        serialization.serialization.setValue(newMaterial, material);
	        serialization.serialization.setValue(newMaterial, { name: name, hideFlags: exports.HideFlags.NotEditable });
	...
	__decorate([
	    objectview.oav({ component: "OAVMaterialName" }),
	    serialization.serialize,
	    watcher.watch("_onShaderChanged")
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVObjectView" }),
	    watcher.watch("_onUniformsChanged")
	], Material.prototype, "uniforms", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "渲染参数", component: "OAVObjectView" }),
	    watcher.watch("_onRenderParamsChanged")
	], Material.prototype, "renderParams", void 0);

	/**
	 * 可射线捕获
	 */
	exports.RayCastable = /*@__PURE__*/(function (Behaviour) {
	...
	exports.RayCastable = __decorate([
	    RegisterComponent()
	], exports.RayCastable);
	 ...
	 */
	exports.Renderable = /*@__PURE__*/(function (RayCastable) {
	    function Renderable() {
	    ...
	    Renderable.prototype.localRayIntersection = function localRayIntersection (localRay) {
	        var localNormal = new math.Vector3();
	        //检测射线与边界的碰撞
	...
	__decorate([
	    objectview.oav({ component: "OAVPick", tooltip: "几何体，提供模型以形状", componentParam: { accepttype: "geometry", datatype: "geometry" } }),
	    serialization.serialize,
	    watcher.watch("_onGeometryChanged")
	], exports.Renderable.prototype, "geometry", void 0);
	__decorate([
	    objectview.oav({ component: "OAVPick", tooltip: "材质，提供模型以皮肤", componentParam: { accepttype: "material", datatype: "material" } }),
	    serialization.serialize
	], exports.Renderable.prototype, "material", null);
	__decorate([
	    objectview.oav({ tooltip: "是否投射阴影" }),
	    serialization.serialize
	], exports.Renderable.prototype, "castShadows", void 0);
	__decorate([
	    objectview.oav({ tooltip: "是否接受阴影" }),
	    serialization.serialize
	], exports.Renderable.prototype, "receiveShadows", void 0);
	exports.Renderable = __decorate([
	    RegisterComponent({ single: true })
	], exports.Renderable);
	Object.defineProperty(exports.Node3D.prototype, "isSelfLoaded", {
	    get: function get() {
	        var model = this.getComponent(exports.Renderable);
	        if (model)
	            { return model.isLoaded; }
	        return true;
	    }
	});
	exports.Node3D.prototype.onSelfLoadCompleted = function onSelfLoadCompleted(callback) {
	    if (this.isSelfLoaded) {
	        callback();
	        return;
	    }
	...
	exports.SkinnedMeshRenderer = /*@__PURE__*/(function (Renderable) {
	    ...
	    SkinnedMeshRenderer.prototype.beforeRender = function beforeRender (renderAtomic, scene, camera) {
	        ...
	        var frameId = null;
	        var animation = this.getComponentsInParents(exports.Animation)[0];
	        if (animation) {
	    ...
	    prototypeAccessors.u_skeletonGlobalMatriices.get = function () {
	        if (!this.cacheSkeletonComponent) {
	            ...
	            while (node3d && !skeletonComponent) {
	                skeletonComponent = node3d.getComponent(exports.SkeletonComponent);
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.SkinnedMeshRenderer.prototype, "skinSkeleton", void 0);
	__decorate([
	    serialization.serialize
	], exports.SkinnedMeshRenderer.prototype, "initMatrix", void 0);
	exports.SkinnedMeshRenderer = __decorate([
	    RegisterComponent({ single: true })
	], exports.SkinnedMeshRenderer);
	var defaultSkeletonGlobalMatriices = (function () { var v = [new math.Matrix4x4()]; var i = 150; while (i-- > 1)
	    { v.push(v[0]); } return v; })();
	...
	Timer.prototype.runfunc = function runfunc () {
	    this.currentCount++;
	    this.repeatCount--;
	    this.func.call(this.thisObject, polyfill.lazy.getvalue(this.interval));
	...
	function addTickerFunc(item) {
	    ...
	    if (item.priority == undefined)
	        { item.priority = 0; }
	    item.runtime = Date.now() + polyfill.lazy.getvalue(item.interval);
	...
	function removeTickerFunc(item) {
	    ...
	    for (var i = tickerFuncs.length - 1; i >= 0; i--) {
	        ...
	        if (polyfill.lazy.getvalue(element.interval) == polyfill.lazy.getvalue(item.interval)
	...
	function runTickerFuncs() {
	    ...
	    for (var i = tickerFuncs.length - 1; i >= 0; i--) {
	        ...
	        if (element.runtime < currenttime) {
	            ...
	            element.runtime = nextRuntime(element.runtime, polyfill.lazy.getvalue(element.interval));
	        }
	    }
	    ...
	    needTickerFuncItems.forEach(function (v) {
	        // try
	        // {
	        v.func.call(v.thisObject, polyfill.lazy.getvalue(v.interval));
	        // } catch (error)
	        // {
	...
	prototypeAccessors$2.extenson.get = function () {
	    ...
	    var ext = filesystem.pathUtils.extname(this.assetPath);
	    return ext;
	};
	/**
	 * 父资源
	...
	prototypeAccessors$2.parentAsset.get = function () {
	    var dir = filesystem.pathUtils.dirname(this.assetPath);
	...
	prototypeAccessors$2.fileName.get = function () {
	    console.assert(!!this.assetPath);
	    var fn = filesystem.pathUtils.getName(this.assetPath);
	    return fn;
	};
	/**
	 * 初始化资源
	...
	FileAsset.prototype.read = function read (callback) {
	    ...
	    event.event.once(this, eventtype, function () {
	    ...
	    this.readMeta(function (err) {
	        if (err) {
	            event.event.emit(this$1, eventtype);
	            return;
	        }
	 ...
	 * 文件夹资源
	 */
	exports.FolderAsset = /*@__PURE__*/(function (FileAsset) {
	    function FolderAsset() {
	        FileAsset.apply(this, arguments);
	        this.assetType = exports.AssetType.folder;
	    }
	...
	exports.FolderAsset.extenson = "";
	exports.FolderAsset = __decorate([
	    objectview.ov({ component: "OVFolderAsset" })
	], exports.FolderAsset);
	setAssetTypeClass("folder", exports.FolderAsset);
	 ...
	 * 文件系统
	 */
	prototypeAccessors$3.fs.get = function () { return this._fs || filesystem.fs; };
	/**
	 * 根资源路径
	 */
	...
	ReadRS.prototype.init = function init (callback) {
	    ...
	    this.fs.readObject(this.resources, function (err, object) {
	        if (object) {
	            var allAssets = serialization.serialization.deserialize(object);
	            //
	            ...
	            this$1.createAsset(exports.FolderAsset, this$1.rootPath, null, null, function (err, asset) {
	                callback();
	            });
	        }
	    });
	...
	ReadRS.prototype.createAsset = function createAsset (cls, fileName, value, parent, callback) {
	    ...
	    //
	    var asset = new cls();
	    var assetId = polyfill.mathUtil.uuid();
	    // 初始化
	    asset.rs = this;
	    serialization.serialization.setValue(asset, value);
	    ...
	    // 计算名称
	    fileName = filesystem.pathUtils.getName(fileName);
	    // 设置默认名称
	...
	ReadRS.prototype.readAssetDatas = function readAssetDatas (assetids, callback) {
	    ...
	    task.task.parallel(fns)(function () {
	...
	ReadRS.prototype.getChildrenPathsByPath = function getChildrenPathsByPath (path) {
	    ...
	    var childrenPaths = paths.filter(function (v) {
	        return filesystem.pathUtils.dirname(v) == path;
	    });
	...
	ReadRS.prototype.deserializeWithAssets = function deserializeWithAssets (object, callback) {
	    ...
	    this.readAssetDatas(assetids, function (err, result) {
	        // 创建资源数据实例
	        var assetData = polyfill.classUtils.getInstanceByName(object[polyfill.__class__]);
	        //默认反序列
	        serialization.serialization.setValue(assetData, object);
	        callback(assetData);
	    });
	};
	...
	var ReadWriteRS = /*@__PURE__*/(function (ReadRS) {
	    ...
	    ReadWriteRS.prototype.save = function save (callback) {
	        ...
	        var object = serialization.serialization.serialize(allAssets);
	    ...
	    ReadWriteRS.prototype.moveAsset = function moveAsset (asset, folder, callback) {
	        ...
	        while (index < assets.length) {
	            var ca = assets[index];
	            if (ca instanceof exports.FolderAsset) {
	 ...
	 * 声音监听器
	 */
	exports.AudioListener = /*@__PURE__*/(function (Behaviour) {
	...
	__decorate([
	    watcher.watch("_enabledChanged")
	], exports.AudioListener.prototype, "enabled", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "音量" })
	], exports.AudioListener.prototype, "volume", null);
	exports.AudioListener = __decorate([
	 ...
	 */
	exports.AudioSource = /*@__PURE__*/(function (Behaviour) {
	    function AudioSource() {
	        ...
	        this.distanceModel = exports.DistanceModelType.inverse;
	        this.refDistance = 1;
	    ...
	    AudioSource.prototype._onUrlChanged = function _onUrlChanged () {
	        ...
	        if (this.url) {
	            var url = this.url;
	            filesystem.fs.readArrayBuffer(this.url, function (err, data) {
	                if (err) {
	                    console.warn(err);
	                    return;
	                }
	...
	__decorate([
	    watcher.watch("_enabledChanged")
	], exports.AudioSource.prototype, "enabled", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVPick", tooltip: "声音文件路径", componentParam: { accepttype: "audio" } }),
	    watcher.watch("_onUrlChanged")
	], exports.AudioSource.prototype, "url", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "是否循环播放" })
	], exports.AudioSource.prototype, "loop", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "音量" })
	], exports.AudioSource.prototype, "volume", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "是否启用位置影响声音" })
	], exports.AudioSource.prototype, "enablePosition", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVEnum", tooltip: "距离模式，距离影响声音的方式", componentParam: { enumClass: exports.DistanceModelType } })
	], exports.AudioSource.prototype, "distanceModel", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "表示音频源和收听者之间的最大距离，之后音量不会再降低。该值仅由linear距离模型使用。默认值是10000。" })
	], exports.AudioSource.prototype, "maxDistance", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "表示随着音频源远离收听者而减小音量的参考距离。此值由所有距离模型使用。默认值是1。" })
	], exports.AudioSource.prototype, "refDistance", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "描述了音源离开收听者音量降低的速度。此值由所有距离模型使用。默认值是1。" })
	], exports.AudioSource.prototype, "rolloffFactor", null);
	__decorate([
	    objectview.oav()
	], exports.AudioSource.prototype, "play", null);
	__decorate([
	    objectview.oav()
	], exports.AudioSource.prototype, "stop", null);
	exports.AudioSource = __decorate([
	...
	var LensBase = /*@__PURE__*/(function (Feng3dObject) {
	    function LensBase(aspectRatio, near, far) {
	        ...
	        Feng3dObject.call(this);
	        //
	        this._inverseMatrix = new math.Matrix4x4();
	    ...
	    LensBase.prototype.project = function project (point3d, v) {
	        if ( v === void 0 ) v = new math.Vector3();

	        var v4 = this.matrix.transformVector4(math.Vector4.fromVector3(point3d, 1));
	        v4.toVector3(v);
	        return v;
	    };
	    /**
	    ...
	    LensBase.prototype.unproject = function unproject (point3d, v) {
	        ...
	        var v4 = this.inverseMatrix.transformVector4(math.Vector4.fromVector3(point3d, 1));
	        v4.toVector3(v);
	        return v;
	    };
	    /**
	    ...
	    LensBase.prototype.unprojectRay = function unprojectRay (x, y, ray) {
	        if ( ray === void 0 ) ray = new math.Ray3();

	        var p0 = this.unproject(new math.Vector3(x, y, 0));
	        var p1 = this.unproject(new math.Vector3(x, y, 1));
	        // 初始化射线
	...
	var OrthographicLens = /*@__PURE__*/(function (LensBase) {
	    function OrthographicLens(size, aspect, near, far) {
	        ...
	        this._projectionType = exports.Projection.Orthographic;
	        this.size = size;
	    }
	...
	var PerspectiveLens = /*@__PURE__*/(function (LensBase) {
	    function PerspectiveLens(fov, aspect, near, far) {
	        ...
	        LensBase.call(this, aspect, near, far);
	        this._projectionType = exports.Projection.Perspective;
	        this.fov = fov;
	    }
	    ...
	    PerspectiveLens.prototype.unproject = function unproject (point3d, v) {
	        ...
	        // ！！该计算过程需要参考或者研究透视投影矩阵
	        // 初始化齐次坐标
	        var p4 = math.Vector4.fromVector3(point3d, 1);
	        // 逆投影求出深度值
	 ...
	 * 摄像机
	 */
	exports.Camera = Camera_1 = /*@__PURE__*/(function (Component3D) {
	    function Camera() {
	        Component3D.apply(this, arguments);
	        //
	        this._viewProjection = new math.Matrix4x4();
	        this._viewProjectionInvalid = true;
	        this._backups = { fov: 60, size: 1 };
	        this._frustum = new math.Frustum();
	    ...
	    prototypeAccessors.projection.set = function (v) {
	        ...
	        if (this.lens) {
	            ...
	            near = this.lens.near;
	            far = this.lens.far;
	            serialization.serialization.setValue(this._backups, this.lens);
	        }
	        var fov = this._backups ? this._backups.fov : 60;
	        var size = this._backups ? this._backups.size : 1;
	        if (v == exports.Projection.Perspective) {
	    ...
	    Camera.prototype.getRay3D = function getRay3D (x, y, ray3D) {
	        if ( ray3D === void 0 ) ray3D = new math.Ray3();
	    ...
	    Camera.prototype.getScaleByDepth = function getScaleByDepth (depth, dir) {
	        if ( dir === void 0 ) dir = new math.Vector2(0, 1);
	...
	__decorate([
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: exports.Projection } })
	], exports.Camera.prototype, "projection", null);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVObjectView" })
	], exports.Camera.prototype, "lens", null);
	exports.Camera = Camera_1 = __decorate([
	    AddComponentMenu("Rendering/Camera"),
	    RegisterComponent({ single: true })
	], exports.Camera);
	// 投影后可视区域
	var visibleBox = new math.Box3(new math.Vector3(-1, -1, -1), new math.Vector3(1, 1, 1));
	...
	__decorate([
	    objectview.oav(),
	    watcher.watch("_onCameraChanged")
	], exports.BillboardComponent.prototype, "camera", void 0);
	exports.BillboardComponent = __decorate([
	 ...
	 * 参考
	 */
	exports.CartoonComponent = /*@__PURE__*/(function (Component) {
	    function CartoonComponent() {
	        Component.apply(this, arguments);
	        this.outlineSize = 1;
	        this.outlineColor = new math.Color4(0.2, 0.2, 0.2, 1.0);
	        this.outlineMorphFactor = 0.0;
	        /**
	         * 半兰伯特值diff，分段值 4个(0.0,1.0)
	         */
	        this.diffuseSegment = new math.Vector4(0.1, 0.3, 0.6, 1.0);
	        /**
	         * 半兰伯特值diff，替换分段值 4个(0.0,1.0)
	         */
	        this.diffuseSegmentValue = new math.Vector4(0.1, 0.3, 0.6, 1.0);
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "outlineSize", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "outlineColor", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "outlineMorphFactor", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "diffuseSegment", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "diffuseSegmentValue", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "specularSegment", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.CartoonComponent.prototype, "cartoon_Anti_aliasing", null);
	exports.CartoonComponent = __decorate([
	...
	var Graphics = /*@__PURE__*/(function (Component) {
	    ...
	    Graphics.prototype.draw = function draw (width, height, callback) {
	        ...
	        callback(ctxt);
	        polyfill.dataTransform.canvasToImage(canvas, "png", 1, function (img) {
	            this$1.image = img;
	        });
	        return this;
	    };
	...
	__decorate([
	    objectview.oav(),
	    watcher.watch("_invalidateSceneTransform")
	], exports.HoldSizeComponent.prototype, "holdSize", void 0);
	__decorate([
	    objectview.oav(),
	    watcher.watch("_onCameraChanged")
	], exports.HoldSizeComponent.prototype, "camera", void 0);
	exports.HoldSizeComponent = __decorate([
	...
	exports.OutLineComponent = /*@__PURE__*/(function (Component) {
	    function OutLineComponent() {
	        Component.apply(this, arguments);
	        this.size = 1;
	        this.color = new math.Color4(0.2, 0.2, 0.2, 1.0);
	        this.outlineMorphFactor = 0.0;
	    }
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.OutLineComponent.prototype, "size", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.OutLineComponent.prototype, "color", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.OutLineComponent.prototype, "outlineMorphFactor", void 0);
	exports.OutLineComponent = __decorate([
	 ...
	 */
	exports.WireframeComponent = /*@__PURE__*/(function (Component3D) {
	    function WireframeComponent() {
	        Component3D.apply(this, arguments);
	        this.color = new math.Color4(125 / 255, 176 / 255, 250 / 255);
	    }
	...
	__decorate([
	    objectview.oav()
	], exports.WireframeComponent.prototype, "color", void 0);
	exports.WireframeComponent = __decorate([
	    RegisterComponent()
	 ...
	 * FPS模式控制器
	 */
	exports.FPSController = /*@__PURE__*/(function (Behaviour) {
	    ...
	    prototypeAccessors.auto.set = function (value) {
	        if (this._auto == value)
	            { return; }
	        if (this._auto) {
	            shortcut.windowEventProxy.off("mousedown", this.onMousedown, this);
	            shortcut.windowEventProxy.off("mouseup", this.onMouseup, this);
	            this.onMouseup();
	        }
	        this._auto = value;
	        if (this._auto) {
	            shortcut.windowEventProxy.on("mousedown", this.onMousedown, this);
	            shortcut.windowEventProxy.on("mouseup", this.onMouseup, this);
	        }
	    };
	    FPSController.prototype.init = function init () {
	        Behaviour.prototype.init.call(this);
	        this.keyDirectionDic = {};
	        this.keyDirectionDic["a"] = new math.Vector3(-1, 0, 0); //左
	        this.keyDirectionDic["d"] = new math.Vector3(1, 0, 0); //右
	        this.keyDirectionDic["w"] = new math.Vector3(0, 0, 1); //前
	        this.keyDirectionDic["s"] = new math.Vector3(0, 0, -1); //后
	        this.keyDirectionDic["e"] = new math.Vector3(0, 1, 0); //上
	        this.keyDirectionDic["q"] = new math.Vector3(0, -1, 0); //下
	        this.keyDownDic = {};
	        this.auto = true;
	    };
	    FPSController.prototype.onMousedown = function onMousedown () {
	        ...
	        this.velocity = new math.Vector3();
	        this.keyDownDic = {};
	        shortcut.windowEventProxy.on("keydown", this.onKeydown, this);
	        shortcut.windowEventProxy.on("keyup", this.onKeyup, this);
	        shortcut.windowEventProxy.on("mousemove", this.onMouseMove, this);
	    };
	    FPSController.prototype.onMouseup = function onMouseup () {
	        this.ischange = false;
	        this.preMousePoint = null;
	        this.mousePoint = null;
	        shortcut.windowEventProxy.off("keydown", this.onKeydown, this);
	        shortcut.windowEventProxy.off("keyup", this.onKeyup, this);
	        shortcut.windowEventProxy.off("mousemove", this.onMouseMove, this);
	    };
	    /**
	     * 销毁
	     */
	    ...
	    FPSController.prototype.update = function update () {
	        ...
	        if (this.mousePoint && this.preMousePoint) {
	            ...
	            var up = math.Vector3.Y_AXIS.clone();
	        ...
	        //计算加速度
	        var accelerationVec = new math.Vector3();
	    ...
	    FPSController.prototype.onMouseMove = function onMouseMove (event) {
	        this.mousePoint = new math.Vector2(event.data.clientX, event.data.clientY);
	...
	__decorate([
	    objectview.oav()
	], exports.FPSController.prototype, "acceleration", void 0);
	exports.FPSController = __decorate([
	...
	var LookAtController = /*@__PURE__*/(function (ControllerBase) {
	    function LookAtController(node3d, Node3D) {
	        ...
	        this._origin = new math.Vector3(0.0, 0.0, 0.0);
	        this._upAxis = math.Vector3.Y_AXIS;
	        this._pos = new math.Vector3();
	        if (Node3D)
	            { this.lookAtObject = Node3D; }
	        else
	            { this.lookAtPosition = new math.Vector3(); }
	    }
	...
	var HoverController = /*@__PURE__*/(function (LookAtController) {
	    ...
	    HoverController.prototype.update = function update (interpolate) {
	        ...
	        this._targetNode.x = this._pos.x + this._distance * Math.sin(this._currentPanAngle * polyfill.mathUtil.DEG2RAD) * Math.cos(this._currentTiltAngle * polyfill.mathUtil.DEG2RAD);
	        this._targetNode.z = this._pos.z + this._distance * Math.cos(this._currentPanAngle * polyfill.mathUtil.DEG2RAD) * Math.cos(this._currentTiltAngle * polyfill.mathUtil.DEG2RAD);
	        this._targetNode.y = this._pos.y + this._distance * Math.sin(this._currentTiltAngle * polyfill.mathUtil.DEG2RAD) * this._yFactor;
	 ...
	 * 网格渲染器
	 */
	exports.MeshRenderer = MeshRenderer_1 = /*@__PURE__*/(function (Renderable) {
	...
	exports.MeshRenderer = MeshRenderer_1 = __decorate([
	    RegisterComponent()
	...
	Raycaster.prototype.pick = function pick (ray3D, transforms) {
	    ...
	    var pickingCollisionVOs = transforms.reduce(function (pv, node3d) {
	        var model = node3d.getComponent(exports.RayCastable);
	...
	Mouse3DManager.prototype.dispatch = function dispatch (type) {
	    if (this.viewport) {
	        var bound = polyfill.lazy.getvalue(this.viewport);
	        if (!bound.contains(shortcut.windowEventProxy.clientX, shortcut.windowEventProxy.clientY))
	            { return; }
	    }
	...
	__decorate([
	    watcher.watch("_mouseInputChanged")
	...
	var WindowMouseInput = /*@__PURE__*/(function (MouseInput) {
	    function WindowMouseInput() {
	        ...
	        shortcut.windowEventProxy.on("click", this.onMouseEvent, this);
	        shortcut.windowEventProxy.on("dblclick", this.onMouseEvent, this);
	        shortcut.windowEventProxy.on("mousedown", this.onMouseEvent, this);
	        shortcut.windowEventProxy.on("mouseup", this.onMouseEvent, this);
	        shortcut.windowEventProxy.on("mousemove", this.onMouseEvent, this);
	    }
	 ...
	 * 通过修改Transform的数值实现
	 */
	exports.TransformLayout = TransformLayout_1 = /*@__PURE__*/(function (Component3D) {
	    function TransformLayout() {
	        Component3D.call(this);
	        this._position = new math.Vector3();
	        this._size = new math.Vector3(1, 1, 1);
	        this._leftTop = new math.Vector3(0, 0, 0);
	        this._rightBottom = new math.Vector3(0, 0, 0);
	        /**
	         * 最小锚点，父Transform2D中左上角锚定的规范化位置。
	         */
	        this.anchorMin = new math.Vector3(0.5, 0.5, 0.5);
	        /**
	         * 最大锚点，父Transform2D中左上角锚定的规范化位置。
	         */
	        this.anchorMax = new math.Vector3(0.5, 0.5, 0.5);
	        /**
	         * The normalized position in this RectTransform that it rotates around.
	         */
	        this.pivot = new math.Vector3(0.5, 0.5, 0.5);
	        /**
	         * 布局是否失效
	         */
	        this._layoutInvalid = true;
	        watcher.watcher.watch(this._position, "x", this._invalidateLayout, this);
	        watcher.watcher.watch(this._position, "y", this._invalidateLayout, this);
	        watcher.watcher.watch(this._position, "z", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMin, "x", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMin, "y", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMin, "z", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMax, "x", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMax, "y", this._invalidateLayout, this);
	        watcher.watcher.watch(this.anchorMax, "z", this._invalidateLayout, this);
	        //
	        watcher.watcher.watch(this._leftTop, "x", this._invalidateSize, this);
	        watcher.watcher.watch(this._leftTop, "y", this._invalidateSize, this);
	        watcher.watcher.watch(this._leftTop, "z", this._invalidateSize, this);
	        watcher.watcher.watch(this._rightBottom, "x", this._invalidateSize, this);
	        watcher.watcher.watch(this._rightBottom, "y", this._invalidateSize, this);
	        watcher.watcher.watch(this._rightBottom, "z", this._invalidateSize, this);
	        //
	        watcher.watcher.watch(this._size, "x", this._invalidateSize, this);
	        watcher.watcher.watch(this._size, "y", this._invalidateSize, this);
	        watcher.watcher.watch(this._size, "z", this._invalidateSize, this);
	        watcher.watcher.watch(this.pivot, "x", this._invalidatePivot, this);
	        watcher.watcher.watch(this.pivot, "y", this._invalidatePivot, this);
	        watcher.watcher.watch(this.pivot, "z", this._invalidatePivot, this);
	        //
	    ...
	    TransformLayout.prototype._updateLayout = function _updateLayout () {
	        ...
	        var anchorLeftTop = new math.Vector3(anchorMin.x * parentSize.x - parentPivot.x * parentSize.x, anchorMin.y * parentSize.y - parentPivot.y * parentSize.y, anchorMin.z * parentSize.z - parentPivot.z * parentSize.z);
	        var anchorRightBottom = new math.Vector3(anchorMax.x * parentSize.x - parentPivot.x * parentSize.x, anchorMax.y * parentSize.y - parentPivot.y * parentSize.y, anchorMax.z * parentSize.z - parentPivot.z * parentSize.z);
	...
	__decorate([
	    objectview.oav({ tooltip: "当anchorMin.x == anchorMax.x时对position.x赋值生效，当 anchorMin.y == anchorMax.y 时对position.y赋值生效，否则赋值无效，自动被覆盖。", componentParam: { step: 1, stepScale: 1, stepDownup: 1 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "position", null);
	__decorate([
	    objectview.oav({ tooltip: "宽度，不会影响到缩放值。当 anchorMin.x == anchorMax.x 时对 size.x 赋值生效，当anchorMin.y == anchorMax.y时对 size.y 赋值生效，否则赋值无效，自动被覆盖。", componentParam: { step: 1, stepScale: 1, stepDownup: 1 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "size", null);
	__decorate([
	    objectview.oav({ tooltip: "与最小最大锚点形成的边框的left、right、top、bottom距离。当 anchorMin.x != anchorMax.x 时对 layout.x layout.y 赋值生效，当 anchorMin.y != anchorMax.y 时对 layout.z layout.w 赋值生效，否则赋值无效，自动被覆盖。", componentParam: { step: 1, stepScale: 1, stepDownup: 1 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "leftTop", null);
	__decorate([
	    objectview.oav({ tooltip: "与最小最大锚点形成的边框的left、right、top、bottom距离。当 anchorMin.x != anchorMax.x 时对 layout.x layout.y 赋值生效，当 anchorMin.y != anchorMax.y 时对 layout.z layout.w 赋值生效，否则赋值无效，自动被覆盖。", componentParam: { step: 1, stepScale: 1, stepDownup: 1 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "rightBottom", null);
	__decorate([
	    objectview.oav({ tooltip: "父Transform2D中左上角锚定的规范化位置。", componentParam: { step: 0.01, stepScale: 0.01, stepDownup: 0.01 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "anchorMin", void 0);
	__decorate([
	    objectview.oav({ tooltip: "最大锚点，父Transform2D中左上角锚定的规范化位置。", componentParam: { step: 0.01, stepScale: 0.01, stepDownup: 0.01 } }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "anchorMax", void 0);
	__decorate([
	    objectview.oav({ tooltip: "中心点" }),
	    serialization.serialize
	], exports.TransformLayout.prototype, "pivot", void 0);
	exports.TransformLayout = TransformLayout_1 = __decorate([
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize,
	    watcher.watch("invalidateGeometry")
	...
	var RenderTargetTexture2D = /*@__PURE__*/(function (Texture2D) {
	    function RenderTargetTexture2D() {
	        ...
	        this.OFFSCREEN_HEIGHT = 1024;
	        this.format = renderer.TextureFormat.RGBA;
	        this.minFilter = renderer.TextureMinFilter.NEAREST;
	        this.magFilter = renderer.TextureMagFilter.NEAREST;
	...
	var FrameBufferObject = function FrameBufferObject(width, height) {
	     ...
	     */
	    this._invalid = true;
	    this.frameBuffer = new renderer.FrameBuffer();
	    this.texture = new RenderTargetTexture2D();
	    this.depthBuffer = new renderer.RenderBuffer();
	...
	FrameBufferObject.active = function active (gl, frameBufferObject) {
	    ...
	    if (!obj) {
	        var framebuffer = renderer.FrameBuffer.active(gl, frameBufferObject.frameBuffer);
	        var texture = renderer.Texture.active(gl, frameBufferObject.texture);
	        var depthBuffer = renderer.RenderBuffer.active(gl, frameBufferObject.depthBuffer);
	        // 绑定帧缓冲区对象
	...
	FrameBufferObject.clear = function clear (frameBufferObject) {
	    renderer.GL.glList.forEach(function (gl) {
	        gl.cache.frameBufferObjects = gl.cache.frameBufferObjects || new Map();
	...
	var Light = /*@__PURE__*/(function (Behaviour) {
	    function Light() {
	         ...
	         * 阴影类型
	         */
	        this.shadowType = exports.ShadowType.No_Shadows;
	        /**
	         * 阴影偏差，用来解决判断是否为阴影时精度问题
	         */
	        ...
	        this.shadowCamera = serialization.serialization.setValue(new Entity(), { name: "LightShadowCamera" }).addComponent(exports.Camera);
	    }
	    ...
	    Light.prototype.updateDebugShadowMap = function updateDebugShadowMap (scene, viewCamera) {
	        ...
	        if (!model) {
	            ...
	            model = entity.addComponent(exports.MeshRenderer);
	            model.geometry = Geometry.getDefault("Plane");
	            model.hideFlags = exports.HideFlags.Hide | exports.HideFlags.DontSave;
	            model.node3d.mouseEnabled = false;
	            model.addComponent(exports.BillboardComponent);
	            //材质
	            model.geometry = serialization.serialization.setValue(new PlaneGeometry(), { width: this.lightType == exports.LightType.Point ? 1 : 0.5, height: 0.5, segmentsW: 1, segmentsH: 1, yUp: false });
	            var textureMaterial = model.material = serialization.serialization.setValue(new Material(), { shaderName: "texture", uniforms: { s_texture: this.frameBufferObject.texture } });
	            //
	            // textureMaterial.uniforms.s_texture.url = 'Assets/pz.jpg';
	            // textureMaterial.uniforms.u_color.setTo(1.0, 0.0, 0.0, 1.0);
	            textureMaterial.renderParams.enableBlend = true;
	            textureMaterial.renderParams.sfactor = renderer.BlendFactor.ONE;
	            textureMaterial.renderParams.dfactor = renderer.BlendFactor.ZERO;
	        }
	        ...
	        var billboardComponent = model.getComponent(exports.BillboardComponent);
	...
	__decorate([
	    objectview.oav({ component: "OAVEnum", componentParam: { enumClass: exports.ShadowType } }),
	    serialization.serialize
	], Light.prototype, "shadowType", void 0);
	__decorate([
	    objectview.oav({ tooltip: "是否调试阴影图" })
	 ...
	 * 方向光源
	 */
	exports.DirectionalLight = DirectionalLight_1 = /*@__PURE__*/(function (Light) {
	    function DirectionalLight() {
	        Light.call(this);
	        this.lightType = exports.LightType.Directional;
	    }
	    ...
	    DirectionalLight.prototype.updateShadowByCamera = function updateShadowByCamera (scene, viewCamera, models) {
	        var worldBounds = models.reduce(function (pre, i) {
	            ...
	            pre.union(box);
	            return pre;
	        }, null) || new math.Box3(new math.Vector3(), new math.Vector3(1, 1, 1));
	        // 
	        ...
	        if (!this.orthographicLens) {
	            ...
	            serialization.serialization.setValue(this.orthographicLens, { size: radius, near: this.shadowCameraNear, far: this.shadowCameraNear + radius * 2 });
	        }
	    };
	...
	exports.DirectionalLight = DirectionalLight_1 = __decorate([
	...
	ForwardRenderer.prototype.draw = function draw (gl, scene, camera) {
	    ...
	    uniforms._Time = new math.Vector4(ctime / 20, ctime, ctime * 2, ctime * 3);
	    unblenditems.concat(blenditems).forEach(function (renderable) {
	        ...
	        renderAtomic.uniforms.u_mvMatrix = function () {
	            return polyfill.lazy.getvalue(renderAtomic.uniforms.u_modelMatrix).clone().append(polyfill.lazy.getvalue(renderAtomic.uniforms.u_viewMatrix));
	        };
	        renderAtomic.uniforms.u_ITMVMatrix = function () {
	            return polyfill.lazy.getvalue(renderAtomic.uniforms.u_mvMatrix).clone().invert().transpose();
	        };
	        renderAtomic.shaderMacro.RotationOrder = math.defaultRotationOrder;
	...
	OutlineRenderer.prototype.init = function init () {
	    if (!this.renderAtomic) {
	        ...
	        renderParams.cullFace = renderer.CullFace.FRONT;
	        this.renderAtomic.shader = new renderer.Shader("outline");
	    }
	};
	OutlineRenderer.prototype.draw = function draw (gl, scene, camera) {
	    ...
	    for (var i = 0; i < unblenditems.length; i++) {
	        ...
	        if (renderable.getComponent(exports.OutLineComponent) || renderable.getComponent(exports.CartoonComponent)) {
	            var renderAtomic = renderable.renderAtomic;
	            renderable.beforeRender(renderAtomic, scene, camera);
	...
	ShadowRenderer.prototype.draw = function draw (gl, scene, camera) {
	    var pointLights = scene.activePointLights.filter(function (i) { return i.shadowType != exports.ShadowType.No_Shadows; });
	    for (var i = 0; i < pointLights.length; i++) {
	        pointLights[i].updateDebugShadowMap(scene, camera);
	        this.drawForPointLight(gl, pointLights[i], scene, camera);
	    }
	    var spotLights = scene.activeSpotLights.filter(function (i) { return i.shadowType != exports.ShadowType.No_Shadows; });
	    for (var i = 0; i < spotLights.length; i++) {
	        spotLights[i].updateDebugShadowMap(scene, camera);
	        this.drawForSpotLight(gl, spotLights[i], scene, camera);
	    }
	    var directionalLights = scene.activeDirectionalLights.filter(function (i) { return i.shadowType != exports.ShadowType.No_Shadows; });
	...
	ShadowRenderer.prototype.drawForSpotLight = function drawForSpotLight (gl, light, scene, camera) {
	    ...
	    renderAtomic.renderParams.viewPort = new math.Rectangle(0, 0, light.frameBufferObject.OFFSCREEN_WIDTH, light.frameBufferObject.OFFSCREEN_HEIGHT);
	    //
	...
	ShadowRenderer.prototype.drawGameObject = function drawGameObject (gl, renderable, scene, camera) {
	    var renderAtomic = renderable.renderAtomic;
	    renderable.beforeRender(renderAtomic, scene, camera);
	    renderAtomic.shadowShader = renderAtomic.shadowShader || new renderer.Shader("shadow");
	    //
	    this.renderAtomic.next = renderAtomic;
	...
	var cube2DViewPorts = [
	    new math.Rectangle(), new math.Rectangle(), new math.Rectangle(),
	    new math.Rectangle(), new math.Rectangle(), new math.Rectangle()
	];
	var cubeUps = [
	    new math.Vector3(0, 1, 0), new math.Vector3(0, 1, 0), new math.Vector3(0, 1, 0),
	    new math.Vector3(0, 1, 0), new math.Vector3(0, 0, 1), new math.Vector3(0, 0, -1)
	];
	var cubeDirections = [
	    new math.Vector3(1, 0, 0), new math.Vector3(-1, 0, 0), new math.Vector3(0, 0, 1),
	    new math.Vector3(0, 0, -1), new math.Vector3(0, 1, 0), new math.Vector3(0, -1, 0)
	];
	...
	WireframeRenderer.prototype.init = function init () {
	    if (!this.renderAtomic) {
	        this.renderAtomic = new renderer.RenderAtomic();
	        var renderParams = this.renderAtomic.renderParams;
	        renderParams.renderMode = renderer.RenderMode.LINES;
	...
	WireframeRenderer.prototype.draw = function draw (gl, scene, camera) {
	    ...
	    var unblenditems = scene.getPickCache(camera).unblenditems;
	    var wireframes = unblenditems.reduce(function (pv, cv) { var wireframe = cv.getComponent(exports.WireframeComponent); if (wireframe)
	...
	WireframeRenderer.prototype.drawGameObject = function drawGameObject (gl, renderable, scene, camera, wireframeColor) {
	        if ( wireframeColor === void 0 ) wireframeColor = new math.Color4();

	    var renderAtomic = renderable.renderAtomic;
	    renderable.beforeRender(renderAtomic, scene, camera);
	    var renderMode = polyfill.lazy.getvalue(renderAtomic.renderParams.renderMode);
	    if (renderMode == renderer.RenderMode.POINTS
	        || renderMode == renderer.RenderMode.LINES
	        || renderMode == renderer.RenderMode.LINE_LOOP
	        || renderMode == renderer.RenderMode.LINE_STRIP)
	        { return; }
	    this.init();
	    ...
	    if (!renderAtomic.wireframeindexBuffer || renderAtomic.wireframeindexBuffer.count != 2 * oldIndexBuffer.count) {
	        ...
	        var indices = polyfill.lazy.getvalue(oldIndexBuffer.indices);
	        for (var i = 0; i < indices.length; i += 3) {
	            wireframeindices.push(indices[i], indices[i + 1], indices[i], indices[i + 2], indices[i + 1], indices[i + 2]);
	        }
	        renderAtomic.wireframeindexBuffer = new renderer.Index();
	        renderAtomic.wireframeindexBuffer.indices = wireframeindices;
	    }
	    renderAtomic.wireframeShader = renderAtomic.wireframeShader || new renderer.Shader("wireframe");
	 ...
	 * 点光源
	 */
	exports.PointLight = /*@__PURE__*/(function (Light) {
	    function PointLight() {
	        Light.call(this);
	        this.lightType = exports.LightType.Point;
	        this._range = 10;
	     ...
	     */
	    prototypeAccessors.shadowMapSize.get = function () {
	        return this.shadowMap.getSize().multiply(new math.Vector2(1 / 4, 1 / 2));
	    };
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.PointLight.prototype, "range", null);
	exports.PointLight = __decorate([
	 ...
	 * 聚光灯光源
	 */
	exports.SpotLight = /*@__PURE__*/(function (Light) {
	    function SpotLight() {
	        Light.call(this);
	        this.lightType = exports.LightType.Spot;
	        /**
	         * 光照范围
	         */
	        this.range = 10;
	    ...
	    prototypeAccessors.coneCos.get = function () {
	        return Math.cos(this.angle * 0.5 * polyfill.mathUtil.DEG2RAD);
	    };
	    prototypeAccessors.penumbraCos.get = function () {
	        return Math.cos(this.angle * 0.5 * polyfill.mathUtil.DEG2RAD * (1 - this.penumbra));
	    };
	...
	__decorate([
	    objectview.oav(),
	    serialization.serialize,
	    watcher.watch("_invalidRange")
	], exports.SpotLight.prototype, "range", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize,
	    watcher.watch("_invalidAngle")
	], exports.SpotLight.prototype, "angle", void 0);
	__decorate([
	    objectview.oav(),
	    serialization.serialize
	], exports.SpotLight.prototype, "penumbra", void 0);
	exports.SpotLight = __decorate([
	    RegisterComponent()
	], exports.SpotLight);
	 ...
	 * 天空盒组件
	 */
	exports.SkyBox = /*@__PURE__*/(function (Component3D) {
	    function SkyBox() {
	        Component3D.apply(this, arguments);
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVPick", componentParam: { accepttype: "texturecube", datatype: "texturecube" } })
	], exports.SkyBox.prototype, "s_skyboxTexture", void 0);
	exports.SkyBox = __decorate([
	...
	prototypeAccessors$7.activeModels.get = function () {
	    ...
	    while (node3ds.length > 0) {
	        ...
	        if (!node3d.visible)
	            { continue; }
	        var model = node3d.getComponent(exports.Renderable);
	 ...
	 * 3D场景
	 */
	exports.Scene = /*@__PURE__*/(function (Component3D) {
	    function Scene() {
	        Component3D.apply(this, arguments);
	        /**
	         * 背景颜色
	         */
	        this.background = new math.Color4(0, 0, 0, 1);
	        /**
	         * 环境光强度
	         */
	        this.ambientColor = new math.Color4();
	        /**
	         * 指定所运行环境
	         *
	    ...
	    Scene.prototype.init = function init () {
	        Component3D.prototype.init.call(this);
	        this.entity.hideFlags = this.entity.hideFlags | exports.HideFlags.Hide;
	        this.entity.hideFlags = this.entity.hideFlags | exports.HideFlags.DontTransform;
	        //
	    ...
	    prototypeAccessors.models.get = function () {
	        this._models = this._models || this.node3d.getComponentsInChildren(exports.Renderable);
	        return this._models;
	    };
	    /**
	     * 所有 可见且开启的 Model
	    ...
	    prototypeAccessors.skyBoxs.get = function () {
	        this._skyBoxs = this._skyBoxs || this.node3d.getComponentsInChildren(exports.SkyBox);
	    ...
	    prototypeAccessors.directionalLights.get = function () {
	        return this._directionalLights = this._directionalLights || this.node3d.getComponentsInChildren(exports.DirectionalLight);
	    };
	    ...
	    prototypeAccessors.pointLights.get = function () {
	        return this._pointLights = this._pointLights || this.node3d.getComponentsInChildren(exports.PointLight);
	    };
	    ...
	    prototypeAccessors.spotLights.get = function () {
	        return this._spotLights = this._spotLights || this.node3d.getComponentsInChildren(exports.SpotLight);
	    };
	    ...
	    prototypeAccessors.animations.get = function () {
	        return this._animations = this._animations || this.node3d.getComponentsInChildren(exports.Animation);
	    };
	    ...
	    prototypeAccessors.behaviours.get = function () {
	        this._behaviours = this._behaviours || this.node3d.getComponentsInChildren(exports.Behaviour);
	    ...
	    prototypeAccessors.mouseCheckObjects.get = function () {
	        ...
	        while (i < checkList.length) {
	            ...
	            if (checkObject.mouseEnabled) {
	                if (checkObject.getComponents(exports.Renderable)) {
	    ...
	    Scene.prototype.getPickByDirectionalLight = function getPickByDirectionalLight (light) {
	        ...
	        while (openlist.length > 0) {
	            ...
	            if (!item.visible)
	                { continue; }
	            var model = item.getComponent(exports.Renderable);
	            if (model && (model.castShadows || model.receiveShadows)
	                && !model.material.renderParams.enableBlend
	                && model.material.renderParams.renderMode == renderer.RenderMode.TRIANGLES) {
	                targets.push(model);
	            }
	    ...
	    Scene.prototype.getModelsByCamera = function getModelsByCamera (camera) {
	        ...
	        var results = this.visibleAndEnabledModels.filter(function (i) {
	            var model = i.getComponent(exports.Renderable);
	            if (model.selfWorldBounds) {
	                if (frustum.intersectsBox(model.selfWorldBounds))
	                    { return true; }
	            }
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Scene.prototype, "background", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], exports.Scene.prototype, "ambientColor", void 0);
	...
	SkyBoxRenderer.prototype.init = function init () {
	    if (!this.renderAtomic) {
	        var renderAtomic = this.renderAtomic = new renderer.RenderAtomic();
	        //八个顶点，32个number
	        var vertexPositionData = [
	            -1, 1, -1,
	            1, 1, -1,
	        ...
	        renderAtomic.attributes.a_position = new renderer.Attribute("a_position", vertexPositionData, 3);
	        //6个面，12个三角形，36个顶点索引
	        var indices = [
	            0, 1, 2, 2, 3, 0,
	            6, 5, 4, 4, 7, 6,
	        ...
	        renderAtomic.indexBuffer = new renderer.Index();
	        renderAtomic.indexBuffer.indices = indices;
	        //
	        var renderParams = renderAtomic.renderParams;
	        renderParams.cullFace = renderer.CullFace.NONE;
	        //
	        renderAtomic.shader = new renderer.Shader("skybox");
	    }
	};
	/**
	 * 绘制场景中天空盒
	...
	var View = /*@__PURE__*/(function (Feng3dObject) {
	    function View(canvas, scene, camera, contextAttributes) {
	        ...
	        this._mousePos = new math.Vector2();
	        this._viewRect = new math.Rectangle();
	        ...
	        this.scene = scene || serialization.serialization.setValue(new Entity(), { name: "scene" }).addComponent(exports.Scene);
	        this.camera = camera;
	        this.start();
	    ...
	    prototypeAccessors.camera.get = function () {
	        if (!this._camera) {
	            var cameras = this.scene.getComponentsInChildren(exports.Camera);
	            if (cameras.length == 0) {
	                this._camera = serialization.serialization.setValue(new Entity(), { name: "defaultCamera" }).addComponent(exports.Camera);
	    ...
	    prototypeAccessors.gl.get = function () {
	        if (!this.canvas.gl)
	            { this.canvas.gl = renderer.GL.getGL(this.canvas, this._contextAttributes); }
	    ...
	    prototypeAccessors.mousePos.get = function () {
	        ...
	        this._mousePos.x = shortcut.windowEventProxy.clientX - clientRect.left;
	        this._mousePos.y = shortcut.windowEventProxy.clientY - clientRect.top;
	    ...
	    View.prototype.unproject = function unproject (sX, sY, sZ, v) {
	        ...
	        var gpuPos = this.screenToGpuPosition(new math.Vector2(sX, sY));
	    ...
	    View.prototype.getScaleByDepth = function getScaleByDepth (depth, dir) {
	        ...
	        scale = scale / new math.Vector2(this.viewRect.width * dir.x, this.viewRect.height * dir.y).length;
	        return scale;
	    };
	    /**
	     * 获取屏幕区域内所有实体
	    ...
	    View.prototype.getObjectsInGlobalArea = function getObjectsInGlobalArea (start, end) {
	        ...
	        var rect = new math.Rectangle(min.x, min.y, max.x - min.x, max.y - min.y);
	        //
	        var transforms = this.scene.getComponentsInChildren(exports.Node3D).filter(function (t) {
	            if (t == this$1.scene.node3d)
	                { return false; }
	            var m = t.getComponent(exports.Renderable);
	            if (m) {
	    ...
	    View.createNewScene = function createNewScene () {
	        var scene = serialization.serialization.setValue(new Entity(), { name: "Untitled" }).addComponent(exports.Scene);
	        scene.background.setTo(0.2784, 0.2784, 0.2784);
	        scene.ambientColor.setTo(0.4, 0.4, 0.4);
	        var camera = exports.Camera.create("Main Camera");
	        camera.entity.addComponent(exports.AudioListener);
	        camera.node3d.x = 0;
	        camera.node3d.y = 1;
	        camera.node3d.z = -10;
	        scene.node3d.addChild(camera.node3d);
	        var directionalLight = exports.DirectionalLight.create("DirectionalLight");
	        directionalLight.shadowType = exports.ShadowType.Hard_Shadows;
	...
	var PointGeometry = /*@__PURE__*/(function (Geometry) {
	    ...
	    PointGeometry.prototype.buildGeometry = function buildGeometry () {
	        ...
	        for (var i = 0; i < numPoints; i++) {
	            ...
	            var position = (element && element.position) || math.Vector3.ZERO;
	            var color = (element && element.color) || math.Color4.WHITE;
	            var normal = (element && element.normal) || math.Vector3.ZERO;
	            var uv = (element && element.uv) || math.Vector2.ZERO;
	            indices[i] = i;
	...
	var SegmentGeometry = /*@__PURE__*/(function (Geometry) {
	    ...
	    SegmentGeometry.prototype.addSegment = function addSegment (segment) {
	        var s = new Segment();
	        serialization.serialization.setValue(s, segment);
	    ...
	    SegmentGeometry.prototype.buildGeometry = function buildGeometry () {
	        ...
	        for (var i = 0; i < numSegments; i++) {
	            ...
	            var start = element.start || math.Vector3.ZERO;
	            var end = element.end || math.Vector3.ZERO;
	            ;
	            var startColor = element.startColor || math.Color4.WHITE;
	            var endColor = element.endColor || math.Color4.WHITE;
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVArray", tooltip: "在指定时间进行额外发射指定数量的粒子", componentParam: { defaultItem: function () { return new Segment(); } } }),
	    watcher.watch("invalidateGeometry")
	...
	var Segment = function Segment() {
	     ...
	     * 起点坐标
	     */
	    this.start = new math.Vector3();
	    /**
	     * 终点坐标
	     */
	    this.end = new math.Vector3();
	    /**
	     * 起点颜色
	     */
	    this.startColor = new math.Color4();
	    /**
	     * 终点颜色
	     */
	    this.endColor = new math.Color4();
	};
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "起点坐标" })
	], Segment.prototype, "start", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "终点坐标" })
	], Segment.prototype, "end", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "起点颜色" })
	], Segment.prototype, "startColor", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "终点颜色" })
	], Segment.prototype, "endColor", void 0);
	Entity.registerPrimitive("Segment", function (g) {
	    var model = g.addComponent(exports.MeshRenderer);
	...
	var ColorUniforms = function ColorUniforms() {
	     ...
	     * 颜色
	     */
	    this.u_diffuseInput = new math.Color4();
	};
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], ColorUniforms.prototype, "u_diffuseInput", void 0);
	renderer.shaderlib.shaderConfig.shaders["color"].cls = ColorUniforms;

	var PointUniforms = function PointUniforms() {
	    /**
	     * 颜色
	     */
	    this.u_color = new math.Color4();
	    /**
	     * 点绘制时点的尺寸
	     */
	    this.u_PointSize = 1;
	...
	renderer.shaderlib.shaderConfig.shaders["point"].cls = PointUniforms;
	...
	var SegmentUniforms = function SegmentUniforms() {
	     ...
	     * 颜色
	     */
	    this.u_segmentColor = new math.Color4();
	};
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	], SegmentUniforms.prototype, "u_segmentColor", void 0);
	renderer.shaderlib.shaderConfig.shaders["segment"].cls = SegmentUniforms;
	renderer.shaderlib.shaderConfig.shaders["segment"].renderParams = { renderMode: renderer.RenderMode.LINES, enableBlend: true };
	...
	var StandardUniforms = function StandardUniforms() {
	     ...
	     * 基本颜色
	     */
	    this.u_diffuse = new math.Color4(1, 1, 1, 1);
	    /**
	     ...
	     * 镜面反射颜色
	     */
	    this.u_specular = new math.Color3();
	    /**
	     * 高光系数
	     */
	     ...
	     * 环境光颜色
	     */
	    this.u_ambient = new math.Color4();
	    /**
	     * 环境映射贴图
	     */
	     ...
	     * 雾的颜色
	     */
	    this.u_fogColor = new math.Color3();
	    /**
	     * 雾的密度
	     */
	     ...
	     * 雾模式
	     */
	    this.u_fogMode = exports.FogMode.NONE;
	};
	__decorate([
	    serialization.serialize,
	    objectview.oav()
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "normalMethod" })
	], StandardUniforms.prototype, "s_normal", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "specular" })
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ component: "OAVPick", block: "envMap", componentParam: { accepttype: "texturecube", datatype: "texturecube" } })
	], StandardUniforms.prototype, "s_envMap", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "envMap" })
	], StandardUniforms.prototype, "u_reflectivity", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "fog" })
	...
	__decorate([
	    serialization.serialize,
	    objectview.oav({ block: "fog", component: "OAVEnum", componentParam: { enumClass: exports.FogMode } })
	], StandardUniforms.prototype, "u_fogMode", void 0);
	renderer.shaderlib.shaderConfig.shaders["standard"].cls = StandardUniforms;
	...
	renderer.shaderlib.shaderConfig.shaders["texture"].cls = TextureUniforms;
	...
	var MouseRenderer = /*@__PURE__*/(function (EventEmitter) {
	    ...
	    MouseRenderer.prototype.draw = function draw (gl, viewRect) {
	        var mouseX = shortcut.windowEventProxy.clientX;
	        var mouseY = shortcut.windowEventProxy.clientY;
	...
	SceneUtil.prototype.getActiveRenderers = function getActiveRenderers (scene, camera) {
	    ...
	    while (node3ds.length > 0) {
	        ...
	        if (!node3d.visible)
	            { continue; }
	        var renderer = node3d.getComponent(exports.Renderable);
	...
	var Setting = function Setting() {
	     ...
	     * unity左手坐标系统。
	     */
	    this.coordinateSystem = math.CoordinateSystem.LEFT_HANDED;
	    /**
	     * 引擎中使用的旋转顺序。
	     *
	     * unity YXZ
	     ...
	     * three.js XYZ
	     */
	    this.defaultRotationOrder = math.RotationOrder.YXZ;
	};
	...
	__decorate([
	    watcher.watch("_imageDataChanged")
	...
	Uuid.prototype.getObjectUuid = function getObjectUuid (object) {
	    ...
	    if (!object[__uuid__]) {
	        Object.defineProperty(object, __uuid__, { value: polyfill.mathUtil.uuid() });
	    }
	...
	FunctionWrap.prototype.wrapAsyncFunc = function wrapAsyncFunc (funcHost, func, params, callback) {
	    ...
	    // 监听执行完成事件
	    event.event.once(this, cuuid, function () {
	        // 完成时重新执行函数
	 ...
	 */
	exports.Water = /*@__PURE__*/(function (Renderable) {
	    function Water() {
	        Renderable.apply(this, arguments);
	    ...
	    Water.prototype.beforeRender = function beforeRender (renderAtomic, scene, camera) {
	        ...
	        var lookAtPosition = new math.Vector3(0, 0, -1);
	        lookAtPosition.applyMatrix4x4(rotationMatrix);
	        lookAtPosition.add(cameraWorldPosition);
	        var target = mirrorWorldPosition.subTo(lookAtPosition);
	        target.reflect(normal).negate();
	        target.add(mirrorWorldPosition);
	        var mirrorCamera = serialization.serialization.setValue(new Entity(), { name: "waterMirrorCamera" }).addComponent(exports.Camera);
	        ...
	        var textureMatrix = new math.Matrix4x4([
	            0.5, 0.0, 0.0, 0.0,
	            0.0, 0.5, 0.0, 0.0,
	            0.0, 0.0, 0.5, 0.0,
	            0.5, 0.5, 0.5, 1.0
	        ...
	        var mirrorPlane = math.Plane.fromNormalAndPoint(mirrorCamera.node3d.worldToLocalMatrix.transformVector3(normal), mirrorCamera.node3d.worldToLocalMatrix.transformPoint3(mirrorWorldPosition));
	        var clipPlane = new math.Vector4(mirrorPlane.a, mirrorPlane.b, mirrorPlane.c, mirrorPlane.d);
	        var projectionMatrix = mirrorCamera.lens.matrix;
	        var q = new math.Vector4();
	...
	var WaterUniforms = function WaterUniforms() {
	    ...
	    this.u_waterColor = new math.Color3().fromUnit(0x555555);
	    ...
	    this.u_textureMatrix = new math.Matrix4x4();
	    this.u_sunColor = new math.Color3().fromUnit(0x7F7F7F);
	    this.u_sunDirection = new math.Vector3(0.70707, 0.70707, 0);
	};
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "透明度" })
	], WaterUniforms.prototype, "u_alpha", void 0);
	__decorate([
	    serialization.serialize,
	    objectview.oav({ tooltip: "水体展现的尺寸" })
	...
	exports.Feng3dObject = Feng3dObject;
	exports.FileAsset = FileAsset;
	exports.ForwardRenderer = ForwardRenderer;
	exports.FrameBufferObject = FrameBufferObject;
	exports.FunctionWrap = FunctionWrap;
	exports.Geometry = Geometry;
	exports.GeometryUtils = GeometryUtils;
	exports.Graphics = Graphics;
	exports.HoverController = HoverController;
	exports.ImageDataTexture2D = ImageDataTexture2D;
	exports.ImageTexture2D = ImageTexture2D;
	exports.ImageUtil = ImageUtil;
	exports.LensBase = LensBase;
	exports.Light = Light;
	exports.LightPicker = LightPicker;
	exports.LookAtController = LookAtController;
	exports.Material = Material;
	exports.Mouse3DManager = Mouse3DManager;
	exports.MouseRenderer = MouseRenderer;
	exports.OrthographicLens = OrthographicLens;
	exports.OutlineRenderer = OutlineRenderer;
	exports.ParametricGeometry = ParametricGeometry;
	exports.PerspectiveLens = PerspectiveLens;
	exports.PlaneGeometry = PlaneGeometry;
	exports.PointGeometry = PointGeometry;
	exports.PointUniforms = PointUniforms;
	exports.Pool = Pool;
	exports.PropertyClip = PropertyClip;
	exports.QuadGeometry = QuadGeometry;
	exports.Raycaster = Raycaster;
	exports.ReadRS = ReadRS;
	exports.ReadWriteRS = ReadWriteRS;
	exports.RegExps = RegExps;
	exports.RenderTargetTexture2D = RenderTargetTexture2D;
	exports.ScenePickCache = ScenePickCache;
	exports.SceneUtil = SceneUtil;
	exports.Script = Script;
	exports.SegmentGeometry = SegmentGeometry;
	exports.SegmentUniforms = SegmentUniforms;
	exports.Setting = Setting;
	exports.ShadowRenderer = ShadowRenderer;
	exports.SkeletonJoint = SkeletonJoint;
	exports.SkyBoxRenderer = SkyBoxRenderer$1;
	exports.SphereGeometry = SphereGeometry;
	exports.StandardUniforms = StandardUniforms;
	exports.Stats = Stats;
	exports.Texture2D = Texture2D;
	exports.TextureCube = TextureCube;
	exports.TextureInfo = TextureInfo;
	exports.TextureUniforms = TextureUniforms;
	exports.Ticker = Ticker;
	exports.TorusGeometry = TorusGeometry;
	exports.Uuid = Uuid;
	exports.VideoTexture2D = VideoTexture2D;
	exports.View = View;
	exports.WaterUniforms = WaterUniforms;
	exports.WireframeRenderer = WireframeRenderer;
	exports.debug = debug;
...
}({}, feng3d, feng3d, feng3d, feng3d, feng3d, feng3d, feng3d, feng3d, feng3d, feng3d));
Object.assign(this.feng3d, _feng_d_core);
