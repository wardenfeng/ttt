...
/// <reference types="@feng3d/math" />
/// <reference types="@feng3d/event" />
/// <reference types="@feng3d/filesystem" />
/// <reference types="@feng3d/renderer" />
...
declare namespace feng3d {
    ...
    class MouseInput<T = MouseEventMap> extends EventEmitter<T> {
         ...
         * @param event   事件对象
         */
        emitEvent<K extends keyof T & string>(event: Event<T[K]>): boolean;
    }
    /**
     * Window鼠标事件输入
     */
