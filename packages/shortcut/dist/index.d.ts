 ...
 */
export declare class EventProxy<T = any> extends EventEmitter<T> {
    pageX: number;
    pageY: number;
    clientX: number;
    clientY: number;
     ...
     */
    once<K extends keyof T>(type: K, listener: (event: Event_2<T[K]>) => void, thisObject?: any, priority?: number): this;
    /**
     * 添加监听
     * @param type						事件的类型。
     * @param listener					处理事件的侦听器函数。
 ...
 */
export declare class KeyState extends EventEmitter {
    /**
 ...
 * 快捷键捕获
 */
export declare class ShortCutCapture {
    /**
     * 快捷键环境
     */
    private _shortCut;
 ...
 * 键盘鼠标输入
 */
export declare const windowEventProxy: EventProxy<WindowEventMap>;
